...
nombre.addEventListener("blur",()=>{
    ...
    if(!regexNombre.test(nombre.value)){
        ...
        alert("Favor de llenar de manera correcta el campo con tu nombre correcto");
    Enviar();
    }
    else{
...
telefono.addEventListener("blur",()=>{
    ...
    alert("Favor de llenar de manera correcta el campo de celular");
    Enviar();
...
correo.addEventListener("blur",()=>{
    ...
    if(!regexCorreo.test(correo.value)){
       ...
       alert("Favor de llenar de manera correcta el campo de correo con tu correo correcto");
       Enviar();
    }
    else{
